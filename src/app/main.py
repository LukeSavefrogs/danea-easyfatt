...
#                        Inizio codice                       
# -----------------------------------------------------------
def main(configuration_file: Optional[str] = None):
    # ==================================================================
    ...
    # Flusso completamente diverso
    # Disabilitare i clienti che non hanno ordini
    # Deve essere possibile disabilitare certi ordini da Easyfatt
